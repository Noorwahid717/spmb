...
<div id="updateStatusWawancara" class="modal">
    <h3 class="text-lg font-semibold leading-6 text-gray-700 my-3">
        Ubah Status Ujian Wawancara
    </h3>
    <hr>
    <div class="my-3">
        <div>
            <div class="form-group mb-5 text-xs">
                ...
                <input type="text" id="nama" class="form-control mt-1 read_only" disabled>
            </div>
            <div class="form-group mb-5 text-xs">
                <label for="prodi">Program Studi</label>
                <input type="text" id="prodi" class="form-control mt-1 read_only" disabled>
            </div>
            <input type="hidden" name="id_exam_interview_member" id="id_exam_interview_member">
            <div class="form-group mb-5 text-xs">
                <label for="status_ujian">Status Ujian</label>
                <select name="status_ujian" id="status_ujian" class="form-control mt-1 status_ujian">
            ...
            <div class="form-group mb-5 text-xs">
                <label for="catatan_penguji">Catatan Penguji <span class="text-red">*</span></label>
                <textarea class="form-control mt-1" name="catatan_penguji" id="catatan_penguji" cols="30" rows="2"
                    placeholder="Catatan Penguji"></textarea>
            </div>
        </div>
        <div class="my-2">
