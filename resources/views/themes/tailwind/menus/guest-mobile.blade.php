                        ...
                        {{-- <svg class="w-9 h-9" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 205 205">
                            <defs>
                                <linearGradient id="a" x1="50%" x2="50%" y1="0%" y2="100%">
                                    <stop offset="0%" stop-color="#1B56E7" />
                                    <stop offset="100%" stop-color="#3987E9" />
                                </linearGradient>
                                <linearGradient id="b" x1="50%" x2="50%" y1="0%" y2="100%">
                                    <stop offset="0%" stop-color="#07A2FF" />
                                    <stop offset="100%" stop-color="#3E78EF" />
                                </linearGradient>
                                <linearGradient id="c" x1="50%" x2="50%" y1="0%" y2="100%">
                                    <stop offset="0%" stop-color="#4ADBFA" />
                                    <stop offset="100%" stop-color="#24B4F2" />
                                </linearGradient>
                            </defs>
                ...
                <div>
                    <nav class="grid row-gap-8">
                        <a href="{{ route('wave.blog') }}"
                            ...
                            <svg class="flex-shrink-0 w-6 h-6 ml-0.5 text-wave-600" fill="none" stroke="currentColor"
