...
<div id="detailExamReadQuranMemberModal" class="modal w-full h-full" style="max-width: inherit;">
    <h3 class="text-lg font-semibold leading-6 text-gray-700 my-3">
        Detail Peserta Ujian Baca Al-Quran
    </h3>
    <hr>
    <div class="flex flex-col px-8 mx-auto my-6 lg:flex-row max-w-7xl xl:px-5">
        <div
            ...
            <div
                ...
                <div class="relative flex-1">
                    <h3 class="text-lg font-medium leading-6 text-gray-700">
                        Calon Peserta Seleksi Baca Al-Quran Yang Masih Tersedia
                    </h3>
            ...
            <div class="relative p-5">
                ...
                <input type="hidden" id="available_member_url" class="available_member_url" name="available_member_url"
                    value="{{route('wave.exam-read-quran-getlist-available-member')}}">
                <input type="hidden" id="addReadQuranMemberUrl" class="addReadQuranMemberUrl"
                    name="addReadQuranMemberUrl" value="{{route('wave.exam-read-quran-add-member')}}">
        ...
        <input type="hidden" name="id_exam_read_quran" class="id_exam_read_quran" id="id_exam_read_quran">
        ...
        <div
            ...
            <div
                ...
                <div class="relative flex-1">
                    <h3 class="text-lg font-medium leading-6 text-gray-700">
                        Peserta Seleksi Baca Al-Quran Yang Terploting
                    </h3>
            ...
            <div class="relative p-5">
                ...
                <input type="hidden" id="joined_member_url" class="joined_member_url" name="joined_member_url"
                    value="{{route('wave.exam-read-quran-getlist-joined-member')}}">
                <input type="hidden" id="deleteReadQuranMemberUrl" class="deleteReadQuranMemberUrl"
                    name="deleteReadQuranMemberUrl" value="{{route('wave.exam-read-quran-delete-member')}}">
            </div>
        </div>
    </div>
</div>