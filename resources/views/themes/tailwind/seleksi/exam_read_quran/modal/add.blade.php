...
<div id="addExamReadQuranModal" class="modal">
    <h3 class="text-lg font-semibold leading-6 text-gray-700 my-3">
        Tambah Data Ujian Baca Al-Quran
    </h3>
    <hr>
    <div class="my-3">
        <div>
            ...
            <div class="form-group mb-5 text-xs">
                <label for="tanggal_read_quran">Tanggal Ujian Baca Al-Quran<span class="text-red">*</span></label>
                <input type="date" name="tanggal_read_quran" id="tanggal_read_quran" class="form-control mt-1" value=""
                    placeholder="Tanggal Ujian Baca Al-Quran">
            </div>
            <div class="form-group mb-5 text-xs">
                <label for="waktu_read_quran">Waktu Ujian Baca Al-Quran <span class="text-red">*</span></label>
                <input type="time" name="waktu_read_quran" id="waktu_read_quran" class="form-control mt-1" value=""
                    placeholder="Waktu Ujian Baca Al-Quran">
            </div>
            <div class="form-group mb-5 text-xs">
                <label for="tempat_read_quran">Tempat Ujian Baca Al-Quran <span class="text-red">*</span></label>
                <input type="text" name="tempat_read_quran" id="tempat_read_quran" class="form-control mt-1" value=""
                    placeholder="Tempat Ujian Baca Al-Quran">
            </div>
        </div>
        <input type="hidden" id="addExamReadQuranUrl" name="addExamReadQuranUrl"
            value="{{route('wave.exam-read-quran-add')}}">
        <div class="my-2">
            ...
            <button onclick="addExamReadQuran()"
