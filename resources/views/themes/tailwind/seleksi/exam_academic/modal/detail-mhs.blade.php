...
<div id="detailExamAcademicMemberModal" class="modal w-full h-full" style="max-width: inherit;">
    <h3 class="text-lg font-semibold leading-6 text-gray-700 my-3">
        Detail Peserta Ujian Akademik
    </h3>
    <hr>
    <div class="flex flex-col px-8 mx-auto my-6 lg:flex-row max-w-7xl xl:px-5">
        <div
            ...
            <div
                ...
                <div class="relative flex-1">
                    <h3 class="text-lg font-medium leading-6 text-gray-700">
                        Calon Peserta Seleksi Akademik Yang Masih Tersedia
                    </h3>
            ...
            <div class="relative p-5">
                ...
                <input type="hidden" id="available_member_url" class="available_member_url" name="available_member_url"
                    value="{{route('wave.exam-academic-getlist-available-member')}}">
                <input type="hidden" id="addAcademicMemberUrl" class="addAcademicMemberUrl" name="addAcademicMemberUrl"
                    value="{{route('wave.exam-academic-add-member')}}">
        ...
        <input type="hidden" name="id_exam_academic" class="id_exam_academic" id="id_exam_academic">
        ...
        <div
            ...
            <div
                ...
                <div class="relative flex-1">
                    <h3 class="text-lg font-medium leading-6 text-gray-700">
                        Peserta Seleksi Akademik Yang Terploting
                    </h3>
            ...
            <div class="relative p-5">
                ...
                <input type="hidden" id="joined_member_url" class="joined_member_url" name="joined_member_url"
                    value="{{route('wave.exam-academic-getlist-joined-member')}}">
                <input type="hidden" id="deleteAcademicMemberUrl" class="deleteAcademicMemberUrl"
                    name="deleteAcademicMemberUrl" value="{{route('wave.exam-academic-delete-member')}}">
            </div>
        </div>
    </div>
</div>