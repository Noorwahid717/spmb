...
<div id="editInterviewQuestionModal" class="modal">
    <h3 class="text-lg font-semibold leading-6 text-gray-700 my-3">
        Edit Data Soal Interview
    </h3>
    <hr>
    <div class="my-3">
        <div>
            <input type="hidden" name="edit_soal_interview_id" id="edit_soal_interview_id"
                class="edit_soal_interview_id">
        ...
        <input type="hidden" id="editInterviewQuestionUrl" name="editInterviewQuestionUrl"
            value="{{route('wave.interview-question-edit')}}">
        <div class="my-2">
            ...
            <button onclick="editInterviewQuestion()"
