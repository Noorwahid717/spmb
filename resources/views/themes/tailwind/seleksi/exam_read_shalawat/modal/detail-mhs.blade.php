...
<div id="detailExamReadShalawatMemberModal" class="modal w-full h-full" style="max-width: inherit;">
    <h3 class="text-lg font-semibold leading-6 text-gray-700 my-3">
        Detail Peserta Ujian Hafalan Shalawat Wahidiyah
    </h3>
    <hr>
    <div class="flex flex-col px-8 mx-auto my-6 lg:flex-row max-w-7xl xl:px-5">
        <div
            ...
            <div
                ...
                <div class="relative flex-1">
                    <h3 class="text-lg font-medium leading-6 text-gray-700">
                        Calon Peserta Seleksi Hafalan Shalawat Wahidiyah Yang Masih Tersedia
                    </h3>
            ...
            <div class="relative p-5">
                ...
                <input type="hidden" id="available_member_url" class="available_member_url" name="available_member_url"
                    value="{{route('wave.exam-read-shalawat-getlist-available-member')}}">
                <input type="hidden" id="addReadShalawatMemberUrl" class="addReadShalawatMemberUrl"
                    name="addReadShalawatMemberUrl" value="{{route('wave.exam-read-shalawat-add-member')}}">
        ...
        <input type="hidden" name="id_exam_read_shalawat" class="id_exam_read_shalawat" id="id_exam_read_shalawat">
        ...
        <div
            ...
            <div
                ...
                <div class="relative flex-1">
                    <h3 class="text-lg font-medium leading-6 text-gray-700">
                        Peserta Seleksi Hafalan Shalawat Wahidiyah Yang Terploting
                    </h3>
            ...
            <div class="relative p-5">
                ...
                <input type="hidden" id="joined_member_url" class="joined_member_url" name="joined_member_url"
                    value="{{route('wave.exam-read-shalawat-getlist-joined-member')}}">
                <input type="hidden" id="deleteReadShalawatMemberUrl" class="deleteReadShalawatMemberUrl"
                    name="deleteReadShalawatMemberUrl" value="{{route('wave.exam-read-shalawat-delete-member')}}">
            </div>
        </div>
    </div>
</div>