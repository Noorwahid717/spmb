...
<head>
    <title>HASIL SELEKSI WAWANCARA</title>
    <style>
        @page {
            margin-bottom: 0px;
        }
...
<body>
    ...
    <div style="text-align: center;line-height: 1.4;margin-top:-30px;margin-bottom:-7px;">
        <strong style="font-size: 14pt">HASIL SELEKSI WAWANCARA</strong>
        <br>
    ...
    <table id="rtable" style="margin-top: 15px;">
        <tr>
            <th rowspan="1" style="width: 15px;height:25px">No</th>
            <th rowspan=" 1" style="width: 180px;height:25px">Nama</th>
            <th rowspan="1" style="width: 180px;height:25px">Program Studi</th>
            {{-- <th rowspan="2">Total Soal</th>
            <th colspan="3">Jawaban</th>
            <th rowspan="2">Nilai</th> --}}
            <th rowspan="1" style="width: 50px;height:25px">Status Ujian</th>
        </tr>
        {{-- <tr>
            <th>Benar</th>
            <th>Salah</th>
        ...
        <tr>
            ...
            <td class="center">{{$data['benar']}}</td>
            <td class="center">{{$data['salah']}}</td>
            <td class="center">{{$data['tak_terjawab']}}</td>
