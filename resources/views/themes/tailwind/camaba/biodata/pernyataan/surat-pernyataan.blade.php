...
<body>
    ...
    <p style="font-size:14px;line-height: 1.5rem;text-align: justify;text-indent:5%">
        ...
        nadzroh Ghoutsu Hadzaz Zaman RA, serta do’a restu Hadrotul Mukarrom Kanjeng Romo K. Abdul Majid Ali Fikri RA,
    ...
    <div style="margin-top: 160px;text-align:center;">
        <div style="width:100%;display:block;font-size:14px;">
            ...
            <br><br>
            <br><br>
            <span style="text-align: right">Kanjeng Romo K. Abdul Majid Ali Fikri RA.</span>
        </div>
    </div>
