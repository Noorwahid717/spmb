<form action="{{ route('wave.settings.profile.put') }}" method="POST" enctype="multipart/form-data">
    <div class="relative flex flex-col px-10 py-8 lg:flex-row">
        ...
        <div class="w-full lg:w-9/12 xl:w-4/5">
            ...
            <div>
                ...
                <div class="mt-1 rounded-md shadow-sm">
                    <input id="nik" type="text" name="nik" placeholder="NIK"
                        value="{{ Auth::user()->nik }}" required class="w-full form-input">
                </div>
            </div>
            ...
            <div class="mt-5">
                <label for="email" class="block text-sm font-medium leading-5 text-gray-700">Alamat Email</label>
                <div class="mt-1 rounded-md shadow-sm">
            ...
            <div class="mt-5">
                <label for="no_hp_camaba" class="block text-sm font-medium leading-5 text-gray-700">Nomor Handphone
                    Pribadi</label>
                <div class="mt-1 rounded-md shadow-sm">
                    <input id="no_hp_camaba" type="text" name="no_hp_camaba" placeholder="Nomor Whatsapp"
                        value="{{ Auth::user()->no_hp_camaba }}" required class="w-full form-input">
                </div>
            </div>

            <div class="mt-5">
                <label for="no_hp_ortu" class="block text-sm font-medium leading-5 text-gray-700">Nomor Handphone
                    Ortu/Wali</label>
                <div class="mt-1 rounded-md shadow-sm">
                    <input id="no_hp_ortu" type="text" name="no_hp_ortu" placeholder="Nomor Whatsapp"
                        value="{{ Auth::user()->no_hp_ortu }}" required class="w-full form-input">
                </div>
            </div>
            ...
            <div class="flex justify-end w-full">
                <button
                    ...
                    dusk="update-profile-button">Simpan</button>
            </div>
        </div>
    </div>
            ...
            <div>
                <div class="mt-3 text-center sm:mt-5">
                    <h3 class="text-lg font-medium leading-6 text-gray-900" id="modal-headline">
                        Posisikan dan ubah ukuran foto Anda
                    </h3>
                    <div class="mt-2">
            ...
            <div class="mt-5 sm:mt-6">
                <span class="flex w-full rounded-md shadow-sm">
                    ...
                    <button @click="$store.uploadModal.open = false; window.applyImageCrop()"
                        ...
                        id="apply-crop" type="button">Terapkan</button>
                </span>
            </div>
        </div>
    </div>
