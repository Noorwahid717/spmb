<form action="{{ route('wave.settings.security.put') }}" method="POST" enctype="multipart/form-data">
	<div class="relative flex flex-col px-10 py-8">
		...
		<div>
			<label for="current_password" class="block text-sm font-medium leading-5 text-gray-700">kata sandi saat ini</label>
		...
		<div class="mt-5">
			<label for="password" class="block text-sm font-medium leading-5 text-gray-700">kata sandi baru</label>
			<div class="mt-1 rounded-md shadow-sm">
		...
		<div class="mt-5">
			<label for="password_confirmation" class="block text-sm font-medium leading-5 text-gray-700">Konfirmasi kata sandi baru</label>
			<div class="mt-1 rounded-md shadow-sm">
