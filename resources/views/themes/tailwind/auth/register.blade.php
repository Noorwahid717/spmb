        ...
        <div class="px-4 py-8 bg-white border shadow border-gray-50 sm:rounded-lg sm:px-10">
            <form
                ...
                <div class="mt-6">
                    ...
                    <div class="mt-1 rounded-md shadow-sm">
                        <input id="email" type="email" name="email" placeholder="Email utama" value="{{ old('email') }}"
                ...
                <div class="mt-6">
                    ...
                    <div class="mt-1 rounded-md shadow-sm">
                        <input id="no_hp_camaba" type="text" name="no_hp_camaba" placeholder="nomor whatsapp*" required
                            class="w-full form-input" value="{{ old('no_hp_camaba') }}"
                ...
                <div class="mt-5 row mb-3">
                    <label for="bukti_pembayaran" class="col-md-4 col-form-label text-md-end">{{ __('Bukti Pembayaran
                        Administrasi') }}</label>

                    <div class="col-md-6">
                        <input id="bukti_pembayaran" type="file"
                            class="form-control @error('bukti_pembayaran') is-invalid @enderror" name="bukti_pembayaran"
                            value="{{ old('bukti_pembayaran') }}" required autocomplete="bukti_pembayaran">
                ...
                <div class="flex flex-col items-center justify-center text-sm leading-5">
                    <span class="block w-full mt-5 rounded-md shadow-sm">
                        <button {{-- type="submit" --}}
                            class="flex justify-center w-full px-4 py-2 text-sm font-medium text-white transition duration-150 ease-in-out border border-transparent rounded-md bg-wave-400 hover:bg-wave-600 focus:outline-none focus:border-wave-700 focus:shadow-outline-wave active:bg-wave-700">
                            Daftar
                        </button>
                    </span>
                    <a href="{{ route('login') }}"
